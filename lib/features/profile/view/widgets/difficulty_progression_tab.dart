...
class DifficultyProgressionTab extends StatefulWidget {
  ...
  @override
  State<DifficultyProgressionTab> createState() => _DifficultyProgressionTabState();
}
...
class _DifficultyProgressionTabState extends State<DifficultyProgressionTab> {
      ...
      builder: (context, progressionService, child) {
        return FutureBuilder<Map<DifficultyLevel, bool>>(
          ...
          builder: (context, snapshot) {
            ...
            final unlockedLevels = progressionState.values.where((unlocked) => unlocked).length;
                  ...
                  ...levels.asMap().entries.map((entry) {
                    ...
                    return Column(
                      children: [
                        ...
                        if (!isLast) _buildConnector(context, isUnlocked, isMobile),
                      ],
                    );
                  }).toList(),
                ],
  ...
  Widget _buildLevelItem(BuildContext context, DifficultyLevel level, bool isUnlocked, bool isMobile) {
    return Container(
      padding: EdgeInsets.all(isMobile ? 16 : 20),
      decoration: BoxDecoration(
        color: isUnlocked ? AppTheme.primaryPurple.withOpacity(0.1) : Colors.grey.withOpacity(0.1),
        borderRadius: BorderRadius.circular(isMobile ? 12 : 16),
        border: Border.all(
          color: isUnlocked ? AppTheme.primaryPurple.withOpacity(0.3) : Colors.grey.withOpacity(0.3),
          width: 2,
        ),
      ),
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isUnlocked ? Colors.green.withOpacity(0.1) : Colors.red.withOpacity(0.1),
